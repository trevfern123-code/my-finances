...
select th.expect_error($q$ insert into public.manual_loan_payments (user_id, loan_id, date, principal_portion, interest_portion, balance_applied) values ('00000000-0000-0000-0000-0000000000aa', '00000000-0000-0000-0000-0000000000d1', '2026-09-10', 'NaN', 0, 0) $q$, '%manual_loan_payments_principal_portion_check%');
select th.expect_error($q$ insert into public.manual_loan_payments (user_id, loan_id, date, principal_portion, interest_portion, balance_applied) values ('00000000-0000-0000-0000-0000000000aa', '00000000-0000-0000-0000-0000000000d1', '2026-09-10', 1, 'Infinity', 0) $q$, '%manual_loan_payments_interest_portion_check%');
