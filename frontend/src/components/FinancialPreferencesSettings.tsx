...
export function FinancialPreferencesSettings({
  ...
  return (
    <div className="card">
      ...
      <p className="financial-prefs-intro">These settings affect Upcoming Bills, budget averages, and your savings-rate goal. Safe to Spend&rsquo;s own calculation options have their own section.</p>
