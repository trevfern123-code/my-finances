...
import type { Loan, ManualLoan, ManualLoanInput } from '../lib/api';
...
export function LoanProgress({
  ...
  onUpdateManualLoan: (id: string, input: ManualLoanInput) => void;
  ...
  function handleUpdate(input: ManualLoanInput) {
    if (editingLoanId) onUpdateManualLoan(editingLoanId, input);
